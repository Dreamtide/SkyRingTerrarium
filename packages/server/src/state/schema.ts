...
export class SandEarnedSchema extends Schema {
  @type("number") ferrite: number = 0;
  @type("number") volt: number = 0;
  @type("number") pyros: number = 0;
  @type("number") chroma: number = 0;
}
...
export class PlayerSchema extends Schema {
  ...
  @type("string") mechId: string = "vanguard";
  ...
  @type(SandEarnedSchema) sandEarned: SandEarnedSchema = new SandEarnedSchema();
}

export class DogSchema extends Schema {
  @type("string") ownerSessionId: string = "";
  @type("string") name: string = "Pup";
  @type("number") bond: number = 0;
  @type("number") x: number = 0;
  @type("number") y: number = 0;
  @type("number") z: number = 0;
  @type("number") yaw: number = 0;
...
/** A physical spill of cybersand on the battlefield - walk near it to vacuum it up. */
export class SandDropSchema extends Schema {
  @type("string") id: string = "";
  @type("string") sandType: string = "pyros";
...
export class RoomState extends Schema {
  ...
  @type({ map: SandDropSchema }) sandDrops = new MapSchema<SandDropSchema>();
}
